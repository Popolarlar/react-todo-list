...
var connection = "mongodb+srv://admin:admin@cluster0.kzau8.mongodb.net/todolist?retryWrites=true&w=majority"; // Connect to MongoDB via Mongoose

seeder.connect(connection, function () {
  // Load Mongoose models
  seeder.loadModels(["src/models/Todo.js"]); // Clear specified collections
